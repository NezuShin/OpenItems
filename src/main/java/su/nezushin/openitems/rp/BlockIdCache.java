...
public class BlockIdCache {
    ...
    public void build() throws IOException {
        ...
        var blockIdCache = new File(blockstatesDir, "note_block.json");

        Files.writeString(blockIdCache.toPath(), new Gson().toJson(new NoteblockBlockstate(this.noteblockIds)), Charsets.UTF_8);
    }
